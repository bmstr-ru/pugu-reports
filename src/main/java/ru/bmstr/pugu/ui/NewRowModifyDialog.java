 ...
 */
@Component
public class NewRowModifyDialog extends JDialog {
    ...
    private final NewRowModifyDialog iAm;

    @Autowired
    public NewRowModifyDialog(Frame parent) {
        super(parent, true);
        iAm = this;
    }
...
//        dbManager.createStaticDatabase();
        final NewRowModifyDialog window = ctx.getBean(NewRowModifyDialog.class);
